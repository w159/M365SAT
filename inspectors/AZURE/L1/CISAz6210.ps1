...
function Build-CISAz6210
{
    ...
    $inspectorobject = New-Object PSObject -Property @{
        UUID             = "CISAz6210"
        ID               = "6.2.10"
        Title            = "(L1) Ensure that Activity Log Alert exists for Delete Public IP Address rule"
...
function Audit-CISAz6210
{
    try
    {
        ...
        if ($Violation.Count -gt 0) {
            $FinalObject = Build-CISAz6210 -ReturnedValue $Violation -Status "FAIL" -RiskScore "2" -RiskRating "Low"
            return $FinalObject
        }
        else {
            $FinalObject = Build-CISAz6210 -ReturnedValue "No violations found" -Status "PASS" -RiskScore "0" -RiskRating "None"
            return $FinalObject
        }
    ...
    {
        $EndObject = Build-CISAz6210 -ReturnedValue "UNKNOWN" -Status "UNKNOWN" -RiskScore "0" -RiskRating "UNKNOWN"
